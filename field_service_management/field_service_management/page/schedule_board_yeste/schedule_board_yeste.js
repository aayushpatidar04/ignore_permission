frappe.pages['schedule-board-yeste'].on_page_load = function(wrapper) {
	...
	$(document).ready(function () {
		...
		$(document).on("click", ".submit", function () {
			...
			frappe.call({
				method: "field_service_management.field_service_management.page.schedule_board_yeste.schedule_board_yeste.save_form_data",
				args: {
					form_data: formData
				},
		...
		$(document).on("click", ".update", function () {
			...
			// Make an API call to Frappe to save the data in your Doctype
			frappe.call({
				method: "field_service_management.field_service_management.page.schedule_board_yeste.schedule_board_yeste.update_form_data",
				args: {
					form_data: formData
				},
				callback: function (response) {
